...
[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Nuget.Server.Framework.App_Start.NuGetODataConfig), "Start")]

namespace Nuget.Server.Framework.App_Start 
{
